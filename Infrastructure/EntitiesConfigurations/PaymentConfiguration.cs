        ...
        public void Configure(EntityTypeBuilder<Payment> builder)
        {
           // ==================== Table & Constraints ====================
            ...
            builder.ToTable("Payments", t =>
            {
                ...
                // RefundAmount cannot exceed Amount
                t.HasCheckConstraint(
                    "CK_Payments_RefundAmount_Valid",
            ...
            builder.Ignore(x => x.IsRefunded);
            builder.Ignore(x => x.IsFailed);
            builder.Ignore(x => x.ProcessingTime);
            builder.Ignore(x => x.RefundPercentage);
        }
    }
}
