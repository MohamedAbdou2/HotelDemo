        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundIssued = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_Payments_RefundAmount_Valid",
                table: "Payments",
                sql: "[RefundAmount] IS NULL OR [RefundAmount] <= [Amount]");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationCancellations_RefundPending",
                table: "ReservationCancellations",
                column: "RefundIssued",
                filter: "[RefundIssued] = 0 AND [RefundAmount] IS NOT NULL");
