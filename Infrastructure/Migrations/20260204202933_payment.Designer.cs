...
namespace HotelDemo.Migrations
{
    ...
    [Migration("20260204202933_payment")]
                    ...
                    b.ToTable("Payments", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Payments_RefundAmount_Valid", "[RefundAmount] IS NULL OR [RefundAmount] <= [Amount]");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.FeedbackResponse", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Feedback", "Feedback")
                        ...
                        .HasForeignKey("Domain.Models.FeedbackResponse", "FeedbackId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Models.Refund", b =>
                {
                    ...
                    b.HasOne("Domain.Models.User", "ProcessedByUser")
                        .WithMany()
